        ...
        "cueOptions": {
            ...
            "Vocal Lead": {
                "RESET": [
                    ...
                    "foh /ch/06/mix/01/on int 0", "foh /ch/06/mix/02/on int 0", "foh /ch/06/mix/03/on int 1", "foh /ch/06/mix/08/on int 0",
                    "foh /ch/07/mix/01/on int 0", "foh /ch/07/mix/02/on int 0", "foh /ch/07/mix/03/on int 1", "foh /ch/07/mix/08/on int 0",
                    "foh /ch/08/mix/01/on int 0", "foh /ch/08/mix/02/on int 0", "foh /ch/08/mix/03/on int 1", "foh /ch/08/mix/08/on int 0",
                ],
                "1": [
                    "foh /ch/05/mix/01/on int 1", "foh /ch/05/mix/02/on int 1", "foh /ch/05/mix/03/on int 0", "foh /ch/05/mix/08/on int 0",
                    "foh /ch/06/mix/01/on int 0", "foh /ch/06/mix/02/on int 0", "foh /ch/06/mix/03/on int 1", "foh /ch/06/mix/08/on int 0",
                ...
                "2": [
                    "foh /ch/05/mix/01/on int 0", "foh /ch/05/mix/02/on int 0", "foh /ch/05/mix/03/on int 1", "foh /ch/05/mix/08/on int 0",
                ...
                "Talk": [
                    ...
                    "foh /ch/07/mix/01/on int 0", "foh /ch/07/mix/02/on int 0", "foh /ch/07/mix/03/on int 0", "foh /ch/07/mix/08/on int 1",
                    "foh /ch/08/mix/01/on int 0", "foh /ch/08/mix/02/on int 0", "foh /ch/08/mix/03/on int 0", "foh /ch/08/mix/08/on int 1",
                ],
            }
        },
        "faders": {
